...
def index():
    ...
    questions_cur = db.execute("""select questions.id as question_id, questions.question_text, askers.name as asker_name, 
                               ...
                               left join users askers on askers.id = questions.asked_by_id 
                               left join users experts  on experts.id = questions.expert_id 
